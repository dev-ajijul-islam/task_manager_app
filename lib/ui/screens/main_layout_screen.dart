  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: NavigationBar(
        ...
        destinations: [
          _navItem(Icons.new_label_outlined, Icons.new_label, "New", primaryColor, textTheme),
          _navItem(Icons.task_alt_outlined, Icons.task_alt, "Completed", primaryColor, textTheme),
          _navItem(Icons.cancel_outlined, Icons.cancel, "Canceled", primaryColor, textTheme),
          _navItem(Icons.history_toggle_off_outlined, Icons.history_toggle_off, "Progress", primaryColor, textTheme),
        ],
      ),
    );
  }
